...
from envs.gym_utils import get_env_samples, get_obs_from_initial_state
import torchsde
    ...
    def forward(self, xs, ts, noise_std, adjoint=False, method="reversible_heun"):
        ...
        if adjoint:
            ...
            zs, log_ratio = torchsde.sdeint_adjoint(
                self, z0, ts, adjoint_params=adjoint_params, dt=1e-2, logqp=True, method=method, adjoint_method="adjoint_reversible_heun")
        else:
